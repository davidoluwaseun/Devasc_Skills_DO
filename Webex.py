...
def add_members(space_id):
    ...
    emails = ["davidoluwaseun2000@yahoo.com", "yvan.rooseleer@biasc.be"]
    for email in emails:
        data = {
            "roomId": space_id,
            "personEmail": email
...
def publish_url(space_id):
    ...
    message = "Here is the URL to my GitHub repository: https://github.com/davidoluwaseun/Devasc_Skills_DO"
    data = {
        "roomId": space_id,
        "markdown": message
    }
